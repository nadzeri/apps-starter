...
const MultiSelectorTrigger = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn("border-muted bg-background flex flex-wrap gap-1 rounded-lg border p-1 py-2", className)} {...props}>
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <CommandPrimitive.Input
        ...
        className={cn("placeholder:text-muted-foreground ml-2 flex-1 bg-transparent outline-none", className, activeIndex !== -1 && "caret-transparent")}
      />
    );
  }
);
